...
@Entity @Table(name="policy_versions") public class PolicyVersion {
 ...
 @org.hibernate.annotations.JdbcTypeCode(org.hibernate.type.SqlTypes.JSON) @Column(nullable=false,columnDefinition="json") private String definition; @Column(nullable=false,length=64) private String checksum;
