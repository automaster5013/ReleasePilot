...
public class EnvironmentService {
 ...
 @Transactional public Environment create(UUID serviceId,String name,UUID clusterId,String namespace,String rollout,String containerName,String stable,String canary,UUID prometheusId,String selector,UUID policyId){
  ...
  return environments.save(Environment.create(serviceId,name,clusterId,namespace,rollout,containerName,stable,canary,prometheusId,selector,policyId,clock.instant()));}
