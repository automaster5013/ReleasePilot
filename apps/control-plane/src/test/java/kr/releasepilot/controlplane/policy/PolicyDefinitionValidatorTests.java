...
class PolicyDefinitionValidatorTests {
 ...
 @Test void acceptsBlueGreenWithSinglePreviewAnalysisStep(){assertThat(validator.validate(valid().replace("\"CANARY\"","\"BLUE_GREEN\"").replace("[{\"weight\":10,\"minimumObservationSeconds\":300},{\"weight\":30,\"minimumObservationSeconds\":300},{\"weight\":100,\"minimumObservationSeconds\":300}]","[{\"weight\":100,\"minimumObservationSeconds\":300}]")).valid()).isTrue();}
 @Test void rejectsMultipleBlueGreenSteps(){var result=validator.validate(valid().replace("\"CANARY\"","\"BLUE_GREEN\""));assertThat(result.violations()).contains("BLUE_GREEN must define exactly one 100% preview analysis step");}
