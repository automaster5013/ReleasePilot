...
import kr.releasepilot.controlplane.catalog.*; import kr.releasepilot.controlplane.connection.*; import kr.releasepilot.controlplane.identity.UserAccountPrincipal;
...
import static org.springframework.security.test.web.servlet.request.SecurityMockMvcRequestPostProcessors.*; import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.post; import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;
...
class EnvironmentApiTests {
 ...
 @Autowired ClusterConnectionRepository clusters; @Autowired PrometheusConnectionRepository prometheus; @Autowired EnvironmentValidationResultRepository results; private MockMvc mvc;
