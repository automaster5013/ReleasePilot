...
- Chromium: 전체 기능·보안·반응형·접근성 E2E 114개
- Firefox: 역할별 WCAG·키보드·고대비·텍스트 간격·동작 감소 검사 20개
- WebKit: 역할별 WCAG·키보드·고대비·텍스트 간격·동작 감소 검사 20개
- GitHub Actions는 `chromium firefox webkit`을 명시적으로 설치한 뒤 총 154개를 실행한다.
...
로컬 Windows에서는 Chromium 전체 114개와 WebKit 접근성 20개, 총 134개가 통과했다.
...
`35076012341`의 Web Console job은 세 엔진 전체 154개를 통과했다.
...
- Docker Hub CD `35076012547`에서 Web Console 이미지 게시, attestation, GitOps 갱신과 배포 검증이 성공했다.
- GitOps commit `a05eda5`의 Web Console digest `sha256:39b5c394bafa12aceedfe00c83fc3bb8949b5fa956c644b924eda8c486d82f31`을 최종 stable로 승격했다.
