...
- Chromium: 전체 기능·보안·반응형·접근성 E2E 118개
- Firefox: 역할별 WCAG·키보드·고대비·텍스트 간격·동작 감소·대상 크기 검사 24개
- WebKit: 역할별 WCAG·키보드·고대비·텍스트 간격·동작 감소·대상 크기 검사 24개
- GitHub Actions는 `chromium firefox webkit`을 명시적으로 설치한 뒤 총 166개를 실행한다.
...
로컬 Windows에서는 Chromium 전체 118개와 WebKit 접근성 24개, 총 142개가 통과했다.
...
`35077392346`의 Web Console job은 세 엔진 전체 166개를 통과했다.
...
- Docker Hub CD `35077392625`에서 Web Console 이미지 게시, attestation, GitOps 갱신과 배포 검증이 성공했다.
- GitOps commit `17f7511`의 Web Console digest `sha256:a3aa789213d8e57cee741ed4ccaa4ef0860880cf4567c411c6e8d0ad77352147`을 최종 stable로 승격했다.
