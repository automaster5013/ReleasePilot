...
94. Docker Hub CD 배포 후 승인 경계 자동 검증 — 완료 (2026-09-16, GitOps 후 AWS OIDC·EKS namespace read-only access·선택 Rollout digest/Paused-or-Healthy/updated replica·Argo Synced·공개 readiness를 15분 fail-closed polling·Kubernetes mutation 없음·수동 Canary 승격 정책 유지)
