...
106. 고대비·320px 리플로 접근성 CI — 완료 (2026-09-16, VIEWER/DEVELOPER/APPROVER/OPERATOR 강제 색상 모드에서 핵심 제어 표시·문서 가로 넘침 없음·320px 버튼 경계·Tab visible focus 검사 4개 추가·증거 표 내부 스크롤 격리 및 WebKit overflow 보완·단위 35개/lint/typecheck/build·로컬 Chromium 106개+WebKit 접근성 12개=118개 통과·CI 35071980684에서 Chromium/Firefox/WebKit 총 130개 통과·CD 35071980747 성공·Web Console 단일 게시/attestation/GitOps 2c72af6·digest f13a8e8·세 Rollout 2/2 Healthy/Pod 재시작 0·네 Argo 앱 Synced/Healthy·공개 root/health/readiness 200; 실제 Windows High Contrast/스크린 리더/확대 도구 수동 검수는 별도)
